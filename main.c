...
// static char latest_uid[32] = "---";
// static char latest_status[32] = "WAITING";
// static char employees_json[8192] = "{\"employees\":[]}";

// // ================= WEB PAGE =================
// const char* page =
// "<!DOCTYPE html><html><body>"
// "<h2>RFID ONBOARDING</h2>"
// "<button onclick='load()'>Fetch Employees</button>"
// "<ul id='list'></ul>"
...
// "li.innerHTML=e.name+' ('+e.employee_id+')';"
// "list.appendChild(li);"
// "});"
// "});"
// "},1500);"
...
//     return httpd_resp_send(req, employees_json, HTTPD_RESP_USE_STRLEN);
// }
...
//     {
//         httpd_uri_t u1 = {"/", HTTP_GET, root, NULL};
//         httpd_uri_t u2 = {"/get", HTTP_GET, get, NULL};
//         httpd_uri_t u3 = {"/employees", HTTP_GET, employees, NULL};
//         httpd_uri_t u4 = {"/data", HTTP_GET, data, NULL};
...
// // ================= MQTT =================
// static void mqtt_handler(void *handler_args, esp_event_base_t base,
...
//             // FIXED: flexible match
//             if (strstr(full_msg, "EMPLOYEE_LIST"))
//             {
//                 strncpy(employees_json, full_msg, sizeof(employees_json) - 1);
//                 printf("Employees stored\n");
//             }

//            if (strstr(full_msg, "\"type\": \"STATUS\""))
// {
//     char *uid_ptr = strstr(full_msg, "\"uid\":");
//     char *msg_ptr = strstr(full_msg, "\"message\":");

//     if (uid_ptr && msg_ptr)
//     {
//         sscanf(uid_ptr, "\"uid\": \"%[^\"]", latest_uid);
//         sscanf(msg_ptr, "\"message\": \"%[^\"]", latest_status);
...
//         .broker.verification.certificate = (const char *)AmazonRootCA_pem_start,
...
// static void on_card(void *arg, esp_event_base_t base,
...
//         strcpy(latest_uid, uid_str);
//         strcpy(latest_status, "WAITING");
